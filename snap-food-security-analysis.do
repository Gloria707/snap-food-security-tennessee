*===========================================================================*
* TN SNAP & Food Security Project (2020-2023)
* Comparing binary vs. ordered outcomes for metro households
*===========================================================================*
clear all
set more off
* ---- Import each year ----
...
* The CPS FSS stores one record per PERSON. We use egen with by(hrhhid hryear4) to aggregate across all household members before collapsing to one row.
* -----------------------------------------------------------------------
...
* Person-level indicators for aggregation 
...
* -----------------------------------------------------------------------
* DEMOGRAPHICS & SOCIOECONOMICS - Variables already created in the aggregation step
* -----------------------------------------------------------------------
* Household structure
...
*-----------------------------------------------------------------------
* CATEGORICAL VARIABLES FOR REGRESSIONS
*-----------------------------------------------------------------------
gen race_cat = .
...
* income categories - 130% FPL based on household size.
...
* -----------------------------------------------------------------------
* ANALYSIS SAMPLE: keep households with valid outcome & SNAP indicator
* -----------------------------------------------------------------------
...
* -----------------------------------------------------------------------
* FOOD SECURITY STATUS BY SNAP PARTICIPATION
* -----------------------------------------------------------------------
...
*---------------------------------------------------------------------------
*  DISAGGREGATED ANALYSIS BY METRO AREA
*---------------------------------------------------------------------------*
eststo clear
